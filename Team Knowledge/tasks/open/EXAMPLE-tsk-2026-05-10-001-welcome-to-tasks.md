...
linked_my_life: []
linked_session_logs: [2026-05-10-12-00_scaffold_v2.0.0-migration]
...
## What this is
This is a seed task created by the v2.0.0 migration so you can see what a real task file looks like in this folder. It's intentionally trivial — you read it, you close it. The point is to show the shape: frontmatter with required cross-reference arrays, body with "Context one click away," updates, outcome.
...
- Birthed in: [[2026-05-10-12-00_scaffold_v2.0.0-migration]]
...
## Updates
- 2026-05-10 12:00 (scaffold) — created as part of v2.0.0 seed
